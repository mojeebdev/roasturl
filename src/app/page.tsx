...
function LogoMark() {
  return (
    <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Outer octagon ring */}
      <polygon
        points="19,2 30,7 36,18 31,30 19,36 8,30 2,18 8,7"
        stroke="#C8A84B"
        strokeWidth="1"
        fill="none"
        opacity="0.7"
      ...
      {/* Inner octagon */}
      <polygon
        points="19,8 26,11.5 30,18 26,24.5 19,28 12,24.5 8,18 12,11.5"
        stroke="#7B3FF2"
        strokeWidth="0.8"
        fill="rgba(123,63,242,0.08)"
        opacity="0.9"
      />
      {/* Cross-hairs */}
      ...
      {/* Center diamond */}
      <polygon
        points="19,13 23,18 19,23 15,18"
        fill="#C8A84B"
        opacity="0.9"
      />
      {/* Center dot */}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(61,31,140,0.22) 0%, transparent 70%)',
        }}
      />
      ...
      <div
        ...
        style={{ background: 'linear-gradient(90deg, transparent 0%, var(--gold) 30%, var(--gold-bright) 50%, var(--gold) 70%, transparent 100%)', opacity: 0.5 }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center w-full gap-10 max-w-[580px] mx-auto">
        ...
        {/* ── Header / Brand ── */}
        <div className="text-center w-full" style={{ animationDelay: '0s' }}>
          {/* Label */}
          ...
          <div className="flex items-center justify-center gap-4 mb-5">
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              >
                ROAST<span style={{
                  WebkitTextFillColor: 'var(--purple-glow)',
                  fontFamily: 'var(--font-hero)',
                }}>URL</span>
              </h1>
              <p style={{
        ...
        <footer style={{ textAlign: 'center', paddingBottom: '16px' }}>
          ...
          <p style={{
            ...
            <a
              ...
              style={{ color: 'var(--gold-dim)', textDecoration: 'none', transition: 'color 0.2s' }}
