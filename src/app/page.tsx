...
export default function HomePage() {
  ...
  return (
    ...
    >
          ...
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none' }}>
            ...
            <div>
              <span style={{
                ...
                background: 'linear-gradient(135deg, var(--white-80) 0%, var(--gold-bright) 60%, var(--gold) 100%)',
      ...
      {/* Main content */}
      <div className="relative z-10 flex flex-col items-center w-full gap-10 max-w-[580px] mx-auto px-4 py-14">
        ...
        <div className="text-center w-full">
          ...
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: '9px', letterSpacing: '0.3em', color: 'var(--gold-dim)', textTransform: 'uppercase', marginBottom: '16px' }}>
        ...
        {!report && !loading && (
          <div
            className="w-full"
            style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1px', background: 'var(--border-subtle)', border: '1px solid var(--border-subtle)' }}
          >
            {[
        ...
        {!report && !loading && (
          <footer style={{ textAlign: 'center', paddingBottom: '16px', width: '100%' }}>
            ...
            <p style={{ fontFamily: 'var(--font-mono)', fontSize: '9px', letterSpacing: '0.3em', color: 'rgba(200,168,75,0.2)', textTransform: 'uppercase' }}>
              ...
              <a href="https://blindspotlab.xyz" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--gold-dim)', textDecoration: 'none' }}
                onMouseEnter={e => ((e.target as HTMLElement).style.color = 'var(--gold)')}
                onMouseLeave={e => ((e.target as HTMLElement).style.color = 'var(--gold-dim)')}
              >BlindspotLab</a>
              {' '}·{' '}
              <a href="https://arcapush.com" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--gold-dim)', textDecoration: 'none' }}
                onMouseEnter={e => ((e.target as HTMLElement).style.color = 'var(--gold)')}
                onMouseLeave={e => ((e.target as HTMLElement).style.color = 'var(--gold-dim)')}
              >Arcapush</a>
              {' '}·{' '}
              <a href="https://x.com/mojeebeth" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--gold-dim)', textDecoration: 'none' }}
                onMouseEnter={e => ((e.target as HTMLElement).style.color = 'var(--gold)')}
                onMouseLeave={e => ((e.target as HTMLElement).style.color = 'var(--gold-dim)')}
              >@mojeebeth</a>
            </p>
